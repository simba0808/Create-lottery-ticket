...
<div class="container app-main">
        ...
        <span class="btn <?= $btn; ?> btn-sm p-1 px-2 w-100 font-xss"><?php if($status == '1'){echo 'Efetuar pagamento';} ?><?php if($status == '2'){echo 'Visualizar compra';} ?><?php if($status == '3'){echo 'Compra cancelada';} ?></span>
    </a>
       </div>
     </div>
